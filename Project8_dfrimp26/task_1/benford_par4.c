/**
 * File: benford_par4.c -- implements a parallel version of the Benford's Law using a local
 *                         counter array with final update protected by array of mutexes
 * 
...
int N = 0;
double *data;
pthread_mutex_t locks[10]; // Array of mutex locks
